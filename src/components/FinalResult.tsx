    ...
    try {
      ...
      const response = await fetch("/api/performance-review", {
        ...
        body: JSON.stringify({
          ...
          // Scores
          jobKnowledge: Number(initialForm.jobKnowledge),
          qualityOfWork: Number(initialForm.qualityOfWork),
          promptnessOfWork: Number(initialForm.promptnessOfWork),
          qualityMeetsStandards: Number(initialForm.qualityMeetsStandards),
          qualityTimeliness: Number(initialForm.qualityTimeliness),
          qualityWorkOutputVolume: Number(initialForm.qualityWorkOutputVolume),
          qualityConsistency: Number(initialForm.qualityConsistency),
          qualityJobTargets: Number(initialForm.qualityJobTargets),
          adaptabilityOpenness: Number(initialForm.adaptabilityOpenness),
          adaptabilityFlexibility: Number(initialForm.adaptabilityFlexibility),
          adaptabilityResilience: Number(initialForm.adaptabilityResilience),
          activeParticipationScore: Number(initialForm.activeParticipationScore),
          positiveTeamCultureScore: Number(initialForm.positiveTeamCultureScore),
          effectiveCommunicationScore: Number(initialForm.effectiveCommunicationScore),
          consistentAttendanceScore: Number(initialForm.consistentAttendanceScore),
          punctualityScore: Number(initialForm.punctualityScore),
          followsThroughScore: Number(initialForm.followsThroughScore),
          reliableHandlingScore: Number(initialForm.reliableHandlingScore),
          ethicalFollowsPoliciesScore: Number(initialForm.ethicalFollowsPoliciesScore),
          ethicalProfessionalismScore: Number(initialForm.ethicalProfessionalismScore),
          ethicalAccountabilityScore: Number(initialForm.ethicalAccountabilityScore),
          ethicalRespectScore: Number(initialForm.ethicalRespectScore),
          customerListeningScore: Number(initialForm.customerListeningScore),
          customerProblemSolvingScore: Number(initialForm.customerProblemSolvingScore),
          customerProductKnowledgeScore: Number(initialForm.customerProductKnowledgeScore),
          customerProfessionalAttitudeScore: Number(initialForm.customerProfessionalAttitudeScore),
          customerTimelyResolutionScore: Number(initialForm.customerTimelyResolutionScore),
          ...
          finalPercentage: Number(((Number(totalScore) / 5) * 100).toFixed(2)),
          areasForImprovement: initialForm.areasForImprovement,
