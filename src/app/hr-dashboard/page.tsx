...
export default function HRDashboard() {
  ...
  useEffect(() => {
    const unsubscribeReviewSubmitted = eventService.subscribe(
    ...
    const unsubscribeActivityCreated = eventService.subscribe(
    ...
    const unsubscribeDataUpdated = eventService.subscribe(
      EVENTS.DATA_UPDATED,
      () => {
  ...
  const markNotificationAsRead = async (id: string) => {
    try {
      ...
      // Reload notifications from persistent storage
          ...
          <div className="rounded-2xl bg-blue-600 shadow-lg p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex-1">
              ...
              <p className="text-lg text-blue-100 font-medium">
                Manage employees, track reviews, and view HR analytics in one
                place.
              </p>
            </div>
              ...
              {loading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 max-w-md mx-auto">
                    When evaluators complete performance reviews, they will
                    appear here as recent activities for your HR dashboard.
                  </p>
                </div>
              )}
        ...
        {activeTab === "employees" && (
          <Card className="p-8 rounded-2xl shadow-xl border-0 bg-white">
            <div className="flex items-center justify-between mb-6">
              ...
              <Button
                className="bg-blue-600 text-white hover:bg-yellow-400 hover:text-black font-semibold px-6 py-2 rounded-lg"
              ...
              <DialogContent className="max-w-md">
                ...
                <form onSubmit={handleAddEmployee} className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      type="date"
                      value={newEmployee.datehired.date}
                      onChange={(e) =>
                        setNewEmployee((emp) => ({
                          ...emp,
            ...
            >
              <DialogContent className="max-w-md border-0 ">
                ...
                <DialogFooter>
                  <Button
                    className="bg-blue-500 text-white hover:bg-green-400"
                    variant="secondary"
