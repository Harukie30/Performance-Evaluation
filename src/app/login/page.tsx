      ...
      <div className="w-full max-w-5xl bg-blue-600 rounded-lg shadow-xl overflow-hidden flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 p-8 lg:p-12 bg-gray-50 flex flex-col justify-center">
          ...
          <h2 className="text-3xl font-bold text-gray-800 mb-2">
            {isRegisterMode ? "Register Your Account" : "Login To Your Account"}
          </h2>
          <p className="text-gray-600 mb-8">
            {isRegisterMode ? "Create your account to get started." : "Enter your details to login."}
          </p>
          ...
          {isRegisterMode ? (
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full py-2 bg-blue-500 text-white font-semibold rounded hover:bg-yellow-400 hover:text-black transition-colors duration-200"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
              ...
              <p className="text-center text-gray-600 mt-4">
                Already have an account? <a href="#" onClick={() => setIsRegisterMode(false)} className="text-blue-500 hover:underline">Sign In</a>
              </p>
            </form>
          ) : (
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <p className="text-center text-gray-600 mt-4">
                ...
                <a href="#" onClick={() => setIsRegisterMode(true)} className="text-blue-500 hover:underline">
                  Register here
                </a>
              </p>
            </form>
